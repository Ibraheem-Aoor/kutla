                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green bold uppercase">روابط</span>
                        </div>
                        <div class="actions">
                            <a href="{{  route('link.create') }}" class="btn btn-primary">إضافة روابط</a>
                        </div>
                    </div>
                                ...
                                <table-column label="" :sortable="false" :filterable="false">
                                    <template scope="post">
                                        @if(in_array('edit_case',$actions))
                                            <a :href="'{{asset('/')}}dashboard/link/'+post.id+'/edit'">
