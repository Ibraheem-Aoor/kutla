...
@section('content')
    <relase-form :case='{!! isset($relea) ? $relea : 'null' !!}' inline-template>
        <div class="row">
            <div class="col-md-6">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <button id="add-main-img" type="button" style="border: none; background: none;    width: 100%;">
                                        <div class="fileinput-new thumbnail" style="background-color: #eef1f5;">
                                            @if(isset($relea) && $relea->photo)
                                                <img src="{{ asset($relea->photo->thump) }}" style="width: 177px;" id="photo_main_view_src" alt="" />
                                            @else
