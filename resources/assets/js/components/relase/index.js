...
Vue.component('relase-index', {
    ...
    methods: {
        async fetchData({ page, filter, sort }) {
            ...
            const response = await axios.get(`${BASE_URL}/dashboard/releas/search`, {params: { page, filter, sort }});
        ...
        deleteCase(id) {
            swal({
                ...
                () => {
                    axios.delete(`${BASE_URL}/dashboard/releas/` + id).then(response => {
