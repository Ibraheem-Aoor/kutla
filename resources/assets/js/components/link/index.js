...
Vue.component('link-index', {
    ...
    methods: {
        async fetchData({ page, filter, sort }) {
            ...
            const response = await axios.get(`${BASE_URL}/dashboard/link/search`, {params: { page, filter, sort }});
        ...
        deleteCase(id) {
            swal({
                ...
                () => {
                    axios.delete(`${BASE_URL}/dashboard/link/` + id).then(response => {
