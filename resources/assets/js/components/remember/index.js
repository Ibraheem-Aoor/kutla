...
Vue.component('remember-index', {
    ...
    mounted() {
        jQuery('#table1').rowSorter({
            ...
            onDrop: function(tbody, row, new_index, old_index)
            {
                ...
                axios({
                    method: 'post',
                    url: `${BASE_URL}/dashboard/remember/new_orders`,
                    data: data
                }).then(response => {
    ...
    methods: {
        ...
        loadMore() {
            ...
            axios.get(`${BASE_URL}/dashboard/remember/search`, {
                params: {
                    filter: {
                        title: this.title,
                        tag: tage_name,
        ...
        deletePost(id, index) {
            swal({
                ...
                () => {
                    axios.delete(`${BASE_URL}/dashboard/remember/` + id).then(response => {
        ...
        publishPost(id, index) {
            swal({
                ...
                () => {
                    axios.post(`${BASE_URL}/dashboard/remember/publish_post/` + id).then(response => {
        ...
        UnPublishPost(id, index) {
            swal({
                ...
                () => {
                    axios.post(`${BASE_URL}/dashboard/remember/unpublish_post/` + id).then(response => {
        ...
        getReaction(post) {
            ...
            this.show_post= post
            axios.get(`${BASE_URL}/dashboard/remember/get_reaction/` + post_id).then(response => {
