...
class NajahController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('kotla_najah.index', compact('statments','linkes','releas','sliders','private','posts', 'users', 'popular', 'photo', 'videos'));
    }
    ...
    public function category_posts( Request $request,Category $category ,$slug){
        ...
        return view('kotla_najah.posts',compact('posts','name'));
    }
    ...
    public function post_show(Post $post,$slug){
        ...
        return view('kotla_najah.post-view',compact('popular','related','post'));
    ...
    public function aboutUs(){
        ...
        //dd($setting);
        return view('kotla_najah.about_us',compact('setting'));
    ...
    public function getRelase(Request $request){
        ...
        return view('kotla_najah.relase',compact('relases','name'));
    ...
    public function geMedia(Request $request){
        ...
        return view('kotla_najah.media',compact('alboms','name'));
    ...
    public function show_photo(Albom $albom){
        ...
        //$images=$albom->photos;
        return view('kotla_najah.photo',compact('images','name'));
    }
}
