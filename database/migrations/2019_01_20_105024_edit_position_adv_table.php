...
class EditPositionAdvTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \DB::statement("ALTER TABLE `advertisements` CHANGE `position` `position` ENUM('header','main_left','under_main','main_middle_1','main_middle_2','main_middle_3','main_middle_4'
